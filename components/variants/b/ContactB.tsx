        ...
        <div className="mt-16 grid gap-10 lg:grid-cols-2 lg:gap-14">
          <Reveal>
            <div className="flex flex-col gap-6">
              ...
              <div className="flex items-start gap-4 rounded-sm border border-frost-line bg-frost-base p-6">
                ...
                <div>
                  <p className="font-medium text-carbon">{business.address.full}</p>
                  <a
          ...
          <Reveal delay={0.1}>
            <div className="rounded-sm border border-frost-line bg-frost-base p-8 md:p-10">
              <h3 className="font-display text-xl font-bold text-carbon">Kurze Anfrage</h3>
              <p className="mt-2.5 text-sm leading-relaxed text-carbon/60">
                Ein paar Sätze genügen. Wir melden uns zeitnah zurück und sagen
                Ihnen, was der nächste sinnvolle Schritt ist.
              </p>
              <div className="mt-8">
